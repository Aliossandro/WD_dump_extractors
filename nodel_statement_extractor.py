        ...
        for line in inputfile:
            ...
            if counter >= 25000:
                ...
                try:
                    ...
                    statement_all = uniStats.to_dict('records')
                    ...
                    try:
                        ...
                        for stat in statement_all:
                            try:
                                cur.execute("""INSERT INTO statementsData_201710 (itemId, revId, statementId, statProperty, statRank, statType, statValue) VALUES (%(itemId)s, %(revId)s, %(statementId)s, %(statProperty)s, %(statRank)s, %(statType)s, %(statValue)s);""", stat)
                                # print(stat)
                                conn.commit()
                            except:
                                conn.rollback()
                    ...
                    references_all = uniStats.to_dict('records')
                    ...
                    # else:
                        ...
                        qualifier_all = uniStats.to_dict('records')
