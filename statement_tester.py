    ...
    with bz2.open(file_name, 'rt') as inputfile:
        for line in inputfile:
            ...
            if counter >= 250:
                ...
                try:
                    dfRev.to_csv('revisionStore.csv', index=False, mode='a')
                    # print(statement_all)
                    ...
                    refSave = pd.DataFrame(references_all)
                    refSave.to_csv('referenceStore.csv', index=False, mode='a')
                    ...
                    # else:
                        ...
                        qualSave = pd.DataFrame(qualifier_all)
                        qualSave.to_csv('qualStore.csv', index=False, mode='a')
